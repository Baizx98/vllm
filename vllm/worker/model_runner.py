...
from vllm.utils import (DeviceMemoryProfiler, FakeList, GiB_bytes,
                        PyObjectCache, async_tensor_h2d, flatten_2d_lists,
...
class ModelInputForGPU(ModelRunnerInputBase):
    ...
    attn_metadata_list: Optional[List["AttentionMetadata"]] = None
    ...
    def as_broadcastable_tensor_dict(self) -> Dict[str, Any]:
        ...
        # TODO add attn metadata list broadcastable dict
        return tensor_dict
...
class ModelInputForGPUBuilder(ModelRunnerInputBuilderBase[ModelInputForGPU]):
    ...
    class InterDataForSeqGroup:
        ...
        def __init__(
            ...
            *,
            ...
            layer_block_tables: Optional[List[Dict[int, List[int]]]],
            ...
            self.layer_block_tables = layer_block_tables
    ...
    def __init__(
        ...
        self.enable_layer_wise_block = (
            self.runner.cache_config.enable_layer_wise_block)
        ...
        if self.sliding_window is not None:
            ...
            self.block_aligned_sliding_window = (self.sliding_window_blocks *
                                                 self.block_size)
    ...
    def _compute_lens(
        ...
        if inter_data.is_prompt:
            ...
            seq_len = min(seq_len, context_len + token_chunk_size)
              ...
              or self.runner.model_config.is_encoder_decoder):
    ...
    def _compute_for_sliding_window(
        ...
        inter_data.curr_sliding_window_blocks[seq_idx] = (
    ...
    def add_seq_group(self, seq_group_metadata: SequenceGroupMetadata):
        ...
        # TODO (baizx98):pass layer_block_tables to inter_data
        inter_data = self.init_cached_inter_data(
            request_id=seq_group_metadata.request_id,
            seq_ids=seq_ids,
            is_prompt=is_prompt,
            block_tables=seq_group_metadata.block_tables,
            layer_block_tables=seq_group_metadata.layer_block_tables,
    ...
    def build(self) -> ModelInputForGPU:
        ...
        # TODO slot_mapping need
        # Attention metadata.
        attn_metadata_list = None
        attn_metadata = None
        if self.enable_layer_wise_block:
            attn_metadata_list = self.attn_metadata_builder.build_list(
...
class GPUModelRunnerBase(ModelRunnerBase[TModelInputForGPU]):
    ...
    def profile_run(self) -> None:
        ...
        # tensor aliasing.
        # TODO kv_caches need be changed to a big tensor
        # TODO 这里需要改成FakeList，参考CacheEngine
...
class ModelRunner(GPUModelRunnerBase[ModelInputForGPUWithSamplingMetadata]):
    ...
    def execute_model(
        ...
        # TODO attention metadata list need to be added
        if not self.cache_config.enable_layer_wise_block:
        ...
        if (not self.cache_config.enable_layer_wise_block
                and prefill_meta is None and decode_meta.use_cuda_graph):
        ...
        # TODO forward context need to be changed
        # if attn_backend is not flashattn or flashinfo,it's ok
        with set_forward_context(model_input.attn_metadata):
            hidden_or_intermediate_states = model_executable(
                ...
                attn_metadata_list=model_input.
                attn_metadata_list,  # TODO Temporary
